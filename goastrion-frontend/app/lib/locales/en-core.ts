...
const enCore = {
  ...
  hero: {
    ...
    support: {
      before: "Start with a free",
      chart: "birth chart",
      shubhdin: "ShubhDin (good dates)",
      saturn: "Saturn/Sade Sati",
    },
  ...
  cards: {
    ...
    saturn: {
      title: "Saturn Phases",
      desc: "Track Sade Sati, transits and caution days to plan moves wisely.",
      cta: "Open Saturn",
    },
  },
  ...
  skills: {
    ...
    note:
      "<span class='text-slate-300'>Top abilities from natal placements — see where to double-down.</span>",
  ...
  home: {
    ...
    shubhdin: {
      ...
      sub:
        "Data-backed Vedic windows for commitments—marriage, job Change, home purchase, study plans",
      pt1: "Smart windows from your birth details (IST/UTC handled)",
  ...
  create: {
    ...
    reset: "Reset",
    saveTip:
      "If you want to avoid entering your details again, save this chart to your account.",
    validation: {
